...
float _sin(float a){
  if(a < _PI_2){
    ...
    return 0.0001f*(float)sine_array[_round(126.6873f*a)];      // int array optimized
  }else if(a < _PI){
    // return sine_array[(int)(199.0*(1.0 - (a-_PI/2.0) / (_PI/2.0)))];
    //return sine_array[398 - (int)(126.6873*a)];          // float array optimized
    return 0.0001f*(float)sine_array[398 - _round(126.6873f*a)];     // int array optimized
  }else if(a < _3PI_2){
    ...
    return -0.0001f*(float)sine_array[796 - _round(126.6873f*a)];      // int array optimized
  }
}
